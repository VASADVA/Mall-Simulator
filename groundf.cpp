...
class talk
{
    public:
        ...
        string table[7][5]={
            ...
            {" 1","\t","Plastic and Normal Lenses(PNL)","\t"," Rs. 4200"},
            {" 2","\t","Metal and Normal Lenses(MNL)","\t"," Rs. 2700"},
            {" 3","\t","Rimless and Normal Lenses(RNL)","\t"," Rs. 4700"},
            {" 4","\t","Plastic and Blue Lenses(PBL)","\t"," Rs. 5200"},
            {" 5","\t","Metal and Blue Lenses(MBL)","\t"," Rs. 4500"},
            {" 6","\t","Rimless and Blue Lenses(RBL)","\t"," Rs. 9200"}};
            for(int i=0;i<7;i++)
            {
                for(int j=0;j<5;j++)
                {
        ...
        void sale()
        {
            ...
            if (ask1=="Sunglasses")
            {
                ...
                if (ask3=="Aviators")
                {
                    ...
                    cout<<"Let's go to another section"<<endl;
                    }
...
class buying:public max,public watch,public talk
{
    public:
    void layout()
